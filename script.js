...
document.addEventListener("DOMContentLoaded", () => {
 ...
 document.querySelectorAll(".animated-heading").forEach((el) => {
  ...
  // === Gallery Scroll Trigger (keep this GSAP)
...
function startBounceHigh(spans) {
  ...
  spans.forEach((span, i) => {
    tl.to(span, { y: -bounceHeight, duration: 0.25, ease: "power1.out" }, i * 0.1)
  ...
  spans.slice().reverse().forEach((span, i) => {
    ...
    tl.to(span, { y: -bounceHeight, duration: 0.25, ease: "power1.out" }, delay)
